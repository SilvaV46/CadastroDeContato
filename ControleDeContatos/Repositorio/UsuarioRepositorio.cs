...
namespace ControleDeContatos.Repositorio
{
    public class UsuarioRepositorio : IUsuarioRepositorio
    {
        ...
        public UsuarioRepositorio(BancoContext bancoContext) => this._bancoContext = bancoContext;
        ...
        public UsuarioModel AlterarSenha(AlterarSenhaModel alterarSenhaModel)
        {
            ...
            if (!usuarioDB.SenhaValida(alterarSenhaModel.SenhaAtual)) throw new Exception("Senha atrual não confere!");
